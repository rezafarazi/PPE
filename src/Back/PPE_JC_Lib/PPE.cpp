...
extern "C"
{
    ...
    JNIEXPORT jstring JNICALL GetEncrypt(JNIEnv *env, jobject obj, jstring VALUE) {
    ...
    //    std::cout << "Current Time Key: " << base64_encode(timeKey) << "\n";
        ...
        std::string EN = GETPPESINGLE(jStringToString(env,VALUE), timeKey, 1);
        return stringToJString(env,EN);
    }

    JNIEXPORT jstring JNICALL GetDecrypt(JNIEnv *env, jobject obj, jstring VALUE) {
        //Generate unixtime key test
        std::string timezone = "Asia/Tehran";
        std::string timeKey = GetCurrentTimeKey(timezone, false);
        //    std::cout << "Current Time Key: " << timeKey << "\n";
        ...
        std::string DE = GETPPESINGLE(jStringToString(env,VALUE), timeKey, 0);
        return stringToJString(env,DE);
    }
