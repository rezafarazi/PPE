...
int main()
{
    ...
    std::cout << "\n---------------------------------------------------\n";
    std::string EN = GETPPESINGLE("HelloWorld123456","0123456789@ABCDEEEEEEEEE",1);
    ...
    std::string DE = GETPPESINGLE("F7ECF85D00E1FD4D577FA0C383A7C86E","0123456789@ABCDEEEEEEEEE",0);
    std::cout << "DEC : " << DE << "\n";
    std::cout << "\n---------------------------------------------------\n";
