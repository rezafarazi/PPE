...
public class AESEncription
{
    ...
    public String Decription(String Value,String TimeZone,String Slat) throws Exception
    {
        String secretKey = new String(com.rezafta.PPE.Encriptions.Key.KeyGenerator.GetCurrentTimeKey(TimeZone,Slat).getBytes());
        secretKey=secretKey.substring(0,16);
