    ...
    public String GetEncription(String value,String TimeZone,String salt, EncriptionTypes type) throws Exception
    {
        ...
        switch (type)
        {
            case AES:
                ...
                AESParalleEncription task_left = new AESParalleEncription(ValueA,TimeZone,salt);
                AESParalleEncription task_right = new AESParalleEncription(ValueB,TimeZone,salt);
//                EnValueA = AES.Encription(ValueA,TimeZone,salt);
//                EnValueB = AES.Encription(ValueB,TimeZone,salt);
...
//                result += AES.Decription(ValueB,salt);
                ...
                AESParalleDecription task_left = new AESParalleDecription(ValueA,TimeZone,salt);
                AESParalleDecription task_right = new AESParalleDecription(ValueB,TimeZone,salt);
