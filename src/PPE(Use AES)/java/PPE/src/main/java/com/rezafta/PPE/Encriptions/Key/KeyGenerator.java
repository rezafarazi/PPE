...
public class KeyGenerator
{
    ...
    public static long getUnixTime(String TimeZone) throws Exception
    {
        try
        {
            String urlString = "https://worldtimeapi.org/api/timezone/"+TimeZone;
    ...
    public static String GetCurrentTimeKey(String TimeZone,String Salt)
    {
        String keybase="";
        ...
        try
        {
            unix_time = getUnixTime(TimeZone);
        }
        catch (Exception e)
        {
